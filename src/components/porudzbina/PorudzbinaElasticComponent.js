...
class SveElasticPorudzbineComponent extends React.Component {
    ...
    ispisiRezultatPoOceni = () => {
        ...
        axios.get("http://localhost:8080/porudzbine6/ocena?minOcena="+this.state.inputMinOcena+"&maxOcena="+this.state.inputMaxOcena).then( (res) =>{
            this.setState({
                porudzbine:res.data
            });
        });
    ...
    ponisti = () => {
        axios.get("http://localhost:8080/porudzbine6/ocena?minOcena=0&maxOcena=5").then( (res) =>{
            this.setState({
                porudzbine:res.data
            });
        });
